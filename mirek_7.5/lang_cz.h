...
const String TXT_FORECAST_VALUES  = "Predpoved na dalsich 72 hodin (3 dny)";
...
const String TXT_PRESSURE_STEADY  = "Konstantni";
...
const String TXT_PRECIPITATION_SOON = "Srazky";

//Sun
const String TXT_SUNRISE  = "slunce vychazi";
const String TXT_SUNSET   = "slunce zapada";

//Moon
const String TXT_MOON_NEW             = "Mesic je v novu";
const String TXT_MOON_WAXING_CRESCENT = "Mesic ma dorustajici srpek";
const String TXT_MOON_FIRST_QUARTER   = "Mesic je v prvni ctvrti";
const String TXT_MOON_WAXING_GIBBOUS  = "Mesic dorusta";
const String TXT_MOON_FULL            = "Mesic je v uplnku";
const String TXT_MOON_WANING_GIBBOUS  = "Mesic couva";
const String TXT_MOON_THIRD_QUARTER   = "Mesic je v posledni ctvrti";
const String TXT_MOON_WANING_CRESCENT = "Mesic zbyva maly srpek";

//Power / WiFi
const String TXT_POWER  = "Baterka";
const String TXT_WIFI   = "WiFi";
const char* TXT_UPDATED = "Posledni aktualizace";


//Wind
const String TXT_WIND_SPEED_DIRECTION = "Rychlost a smer vetru";
